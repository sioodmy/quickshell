...
Variants {
    ...
    delegate: PanelWindow {
        ...
        Item {
            ...
            property real dockTargetWidth: (clockModule ? clockModule.implicitWidth : 0) + (statsModule ? statsModule.implicitWidth : 0) + (dockShareIcon ? dockShareIcon.targetWidth : 0) + (pomodoroWidget ? pomodoroWidget.targetWidth : 0) + (recordingWidget ? recordingWidget.targetWidth : 0) + (mediaIndicator ? mediaIndicator.targetWidth : 0) + (workspaceBar ? workspaceBar.implicitWidth : 0) + 52
